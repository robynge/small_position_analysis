...
with col1:
    ...
    fig_diff.update_layout(title='Daily Difference (Actual - Exclude)', yaxis_title='%', hovermode='closest')
...
with col2:
    ...
    fig_small.update_layout(title=f'{selected_range["label"]} Only Daily Returns', yaxis_title='%', hovermode='closest')
